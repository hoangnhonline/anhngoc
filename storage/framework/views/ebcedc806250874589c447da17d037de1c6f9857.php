...
<section class="content-header">
  <h1>
    Danh mục con của : <span class="cate-name"><?php echo e($parentCate->name); ?></span>
  </h1>
  <ol class="breadcrumb">
...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      <?php endif; ?>
      <a href="<?php echo e(route('cate.create', [$parent_id])); ?>" class="btn btn-info" style="margin-bottom:5px">Tạo mới</a>
