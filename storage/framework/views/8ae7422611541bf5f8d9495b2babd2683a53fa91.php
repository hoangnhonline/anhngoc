...
<div class="content-wrapper">
  ...
  <section class="content">
    <a class="btn btn-default" href="<?php echo e(route('articles-cate.index')); ?>" style="margin-bottom:5px">Quay lại</a>
    <div class="row">
      <!-- left column -->
      ...
      <div class="col-md-7">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form role="form" method="POST" action="<?php echo e(route('articles-cate.update')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default" class="btn btn-primary" href="<?php echo e(route('articles-cate.index')); ?>">Hủy</a>
            </div>
