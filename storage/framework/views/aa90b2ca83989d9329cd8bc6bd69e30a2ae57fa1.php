...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
   <head>
      ...
      <link rel="stylesheet" href="<?php echo e(URL::asset('assets/css/slide.css')); ?>" type="text/css" />
   ...
   <body>
      ...
      <header>
         <div class="container">
            <?php echo $__env->make('layout.home.header-menu', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            <?php echo $__env->make('layout.home.search', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
      ...
      <!-- main -->
      <div id="main" class="<?php echo e($page_name); ?>">
         <div class="container">
            <?php if( $page_name == ""): ?>
               ...
               <div class="row">
                  <div class="col-lg-4 footer-one">
                     <div class="footer-link">
                        ...
                        <p><a title="Top IMDb" href="movie/topimdb">Top IMDb</a></p>
                        <p><a title="DMCA" href="site/dmca">DMCA</a></p>
                        <p><a title="FAQ" href="site/faq">FAQ</a></p>
                        <p><a title="Advertising" href="site/promote">Advertising</a></p>
                        <p><a title="Advertising" href="site/donate">Donate</a></p>
                     </div>
                     <div class="footer-link">
