              ...
              <?php endif; ?>
                <div class="form-group">
                  ...
                  <select class="form-control" name="type">                                
                    <option value="1" <?php echo e(1 ==  old('type') ? "selected" : ""); ?>>Phim</option>
                    <option value="2" <?php echo e(2 ==  old('type') ? "selected" : ""); ?>>Truyện</option>
                    <option value="3" <?php echo e(3 ==  old('type') ? "selected" : ""); ?>>Ảnh</option>                
                  </select>
                </div>
                 <!-- text input -->
                <div class="form-group">
                  <label>Tag<span class="red-star">*</span></label>
                  <input type="text" class="form-control" name="tag" id="tag" value="<?php echo e(old('tag')); ?>">
                </div>
                <div class="form-group">
