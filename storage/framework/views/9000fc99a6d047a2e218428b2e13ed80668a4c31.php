              ...
              <?php endif; ?>
               <div class="form-group">
                  ...
                  <select class="form-control" name="loai_id" id="loai_id">                  
                    <option value="0" <?php echo e($detail->loai_id == 0 ? "selected" : ""); ?>>--chọn--</option>
                    <?php foreach( $loaiSpArr as $value ): ?>
                    <option value="<?php echo e($value->id); ?>" <?php echo e(( $detail->loai_id == $value->id ) ? "selected" : ""); ?>><?php echo e($value->name); ?></option>
                    <?php endforeach; ?>
                  </select>
                </div> 
               <!-- text input -->
