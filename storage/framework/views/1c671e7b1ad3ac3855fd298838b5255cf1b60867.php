              ...
              <?php endif; ?>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="home_style" id="home_style">                  
                    <option value="0" <?php echo e(old('home_style') == 0 ? "selected" : ""); ?>>Không banner</option>
                    <option value="1" <?php echo e(old('home_style') == 1 ? "selected" : ""); ?>>Banner đứng lớn</option>
                    <option value="2" <?php echo e(old('home_style') == 2 ? "selected" : ""); ?>>Banner đứng nhỏ</option>
                    <option value="3" <?php echo e(old('home_style') == 3 ? "selected" : ""); ?>>Banner ngang</option>
                  </select>
                </div>                    
                <div class="form-group">
                  <label>Màu nền</label>
                  <input type="text" class="form-control" name="bg_color" id="bg_color" value="<?php echo e(old('bg_color')); ?>">
                </div>
            </div>
            <!-- /.box-body -->
            <input type="hidden" name="image_url" id="image_url" value="<?php echo e(old('image_url')); ?>"/>
            <input type="hidden" name="icon_url" id="icon_url" value="<?php echo e(old('icon_url')); ?>"/>
            <input type="hidden" name="image_name" id="image_name" value="<?php echo e(old('image_name')); ?>"/>
            <input type="hidden" name="icon_name" id="icon_name" value="<?php echo e(old('icon_name')); ?>"/>
