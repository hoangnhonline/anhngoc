            ...
            <?php if( $items->count() > 0 ): ?>
              ...
              <tr id="row-<?php echo e($item->id); ?>">
                ...
                <td style="white-space:nowrap">                  
                  <a href="<?php echo e(route( 'articles.edit', [ 'id' => $item->id ])); ?>" class="btn btn-warning">Chỉnh sửa</a>                 
                  
                  <a onclick="return callDelete('<?php echo e($item->title); ?>','<?php echo e(route( 'articles.destroy', [ 'id' => $item->id ])); ?>');" class="btn btn-danger">Xóa</a>
