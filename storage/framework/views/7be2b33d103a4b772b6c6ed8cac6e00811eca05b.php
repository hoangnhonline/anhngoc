...
<script type="text/javascript">
    $(document).ready(function(){
      var editor = CKEDITOR.replace( 'content',{
          ...
          language : 'vi',
/*
          filebrowserBrowseUrl : '../dist/js/c/kcfinder/browse.php?type=files',
       
          filebrowserImageBrowseUrl : '../dist/js/ckfinder/ckfinder.html?type=Images',
         
          filebrowserFlashBrowseUrl : '../dist/js/ckfinder/ckfinder.html?type=Flash',
         
          filebrowserUploadUrl : '../dist/js/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files',
        
          filebrowserImageUploadUrl : '../dist/js/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images',
         
          filebrowserFlashUploadUrl : '../dist/js/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash'
*/
