      ...
      <div class="container">
         <div class="row">
            <div class="col-lg-8 footer-one">
               <?php if( $parentArr->count() > 0): ?>
                  ...
                  <div class="footer-link">
                     <h3 class="footer-link-head"><?php echo e($parent->name); ?></h3>
                     <?php if( !empty($cateArr[$parent->id]) ): ?>
                     <?php foreach( $cateArr[$parent->id] as $cate ): ?>
                     <p><a title="<?php echo e($cate->name); ?>" href="/<?php echo e($cate->slug); ?>"><?php echo e($cate->name); ?></a></p>
                     <?php endforeach; ?>
                     <?php endif; ?>
                  </div>
                  <?php endforeach; ?>      
            ...
            <div class="col-lg-4 footer-copyright">
               <p><img border="0" src="<?php echo $__env->yieldContent('logo'); ?>" class="mv-ft-logo"></p>
