...
class HomeController extends Controller
{
    ...
    */
    public function index(Request $request)
    {
        ...
        return view('home.index', compact( 'page_name', 'layout_name', 'parentArr' , 'cateArr', 'moviesActiveArr', 'articlesArr', 'hotArr'));
    }
    ...
    */
    public function search(Request $request)
    {
        ...
        return view('home.cate', compact( 'moviesArr', 'tu_khoa',  'is_search', 'layout_name', 'page_name', 'parentArr' , 'cateArr' ));
    }
    ...
    public function cate(Request $request)
    {
        ...
        return view('home.cate', compact('is_search', 'moviesArr', 'cateDetail', 'layout_name', 'page_name', 'parentArr' , 'cateArr', 'cateActiveArr', 'moviesActiveArr'));
    }
    ...
    public function newsList(Request $request)
    {
        ...
        return view('home.news-list', compact('hotArr', 'layout_name', 'page_name', 'articlesArr' , 'cateArr', 'parentArr'));
    }
    ...
    public function newsDetail(Request $request)
    {
        ...
        if( $detail ){
            ...
            return view('home.news-detail', compact('hotArr', 'layout_name', 'page_name', 'detail' , 'cateArr', 'parentArr'));
        }else{
